...
function wtable!(
    ...
    slz::Vector{Float64}, dz::Vector{Float64}, area::Matrix{Float64},
    soiltxt::Array{Int,3}, wtd::Matrix{Float64}, bottomflux::Matrix{Float64},
    rech::Matrix{Float64}, qslat::Matrix{Float64}, fdepth::Matrix{Float64},
    topo::Matrix{Float64}, landmask::Matrix{Int}, Δt::Float64,
    smoi::Array{Float64,3}, smoieq::Array{Float64,3}, smoiwtd::Matrix{Float64},
    qsprings::Matrix{Float64}
)
    # 计算侧向流导水率
    κlat = zeros(size(wtd))
...
function lateral_flow!(
    ...
    topo::Matrix{Float64}, landmask::Matrix{Int}, Δt::Float64,
    area::Matrix{Float64}, κlat::Matrix{Float64}
)
    # 流动角度因子
