...
function lateral_isotope!(
    ...
    soiltxt::Array{Int,3}, wtd::Matrix{Float64}, qlat::Matrix{Float64},
    fdepth::Matrix{Float64}, topo::Matrix{Float64}, landmask::Matrix{Int},
    Δt::Float64, area::Matrix{Float64}, lats::Matrix{Float64}, dxy::Float64,
    slz::Vector{Float64}, o18::Array{Float64,3}, smoi::Array{Float64,3},
    qlato18::Matrix{Float64}, qlatin::Matrix{Float64}, qlatout::Matrix{Float64},
    qlatino18::Matrix{Float64}, qlatouto18::Matrix{Float64},
    qlatinsum::Matrix{Float64}, qlatoutsum::Matrix{Float64},
    qlatino18sum::Matrix{Float64}, qlatouto18sum::Matrix{Float64}
)
    # 计算侧向流导水率
    κlat = zeros(size(wtd))
...
function lateralflow_with_isotope!(
    ...
    wtd::Matrix{Float64}, qlat::Matrix{Float64}, fdepth::Matrix{Float64},
    topo::Matrix{Float64}, landmask::Matrix{Int}, Δt::Float64,
    area::Matrix{Float64}, κlat::Matrix{Float64}, lats::Matrix{Float64},
    dxy::Float64, o18wtd::Matrix{Float64}, qlato18::Matrix{Float64},
    qlatin::Matrix{Float64}, qlatout::Matrix{Float64}, qlatino18::Matrix{Float64},
    qlatouto18::Matrix{Float64}
)
    # 计算有效导水率和水头
...
function updatedeepwtable!(
    ...
    slz::Vector{Float64}, dz::Vector{Float64}, soiltxt::Array{Int,3},
    wtd::Matrix{Float64}, bottomflux::Matrix{Float64}, rech::Matrix{Float64},
    qslat::Matrix{Float64}, qlat::Matrix{Float64}, landmask::Matrix{Int},
    Δt::Float64, smoi::Array{Float64,3}, smoieq::Array{Float64,3},
    smoiwtd::Matrix{Float64}, qsprings::Matrix{Float64}
)
    # 计算深层补给
...
function updatewtd_simple(
    nzg::Int, slz::Vector{Float64}, dz::Vector{Float64}, 
    wtd::Float64, qspring::Float64, totwater::Float64,
    smoi::AbstractVector{Float64}, smoieq::AbstractVector{Float64},
    soiltextures::Vector{Int}, smoiwtd::Float64
)
    # 这是一个简化版本，主要处理深层水位变化
